...
public class ArcadeDriveCmd extends CommandBase {
    ...
    private final Supplier<Double> speedFunction, turnFunction; //we need functions (called Suppliers for doubles) so that values change based on realtime joystick inputs. 
